...
<html lang="en">
        ...
        <main>
            <div id="filters-container">
                ...
                <div id="filter-links">
                    ...
                    <a href="../html/most-reviewed.html.php">
                        <button class="filter-button" style="background-color: #A66500;"> Most Reviewed</button>
                    </a>
                </div>
            ...
            <div id="results-container"> 
                ...
                <div id="search-container">
                    <span id="subtext">Most Reviewed </span><br> <span id="query"></span>
    ...
    <script src="../js/most_reviews.js"></script>
</html>
