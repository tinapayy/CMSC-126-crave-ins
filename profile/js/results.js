...
function searchData() {
    ...
    var landmarkChoice = document.getElementById('choice').innerText;

    var xhr = new XMLHttpRequest();
    xhr.open('GET', '../php/search.php?query=' + encodeURIComponent(searchQuery) + '&landmark=' + encodeURIComponent(landmarkChoice), true);
...
function displayData(data) {
    ...
    data.forEach(function(element) {
        ...
        const reviewCount = element.review_count;
