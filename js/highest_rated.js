...
function rated() {
    ...
    xhr.open('GET', '../php/highest_rated.php', true);
...
function displayData(data) {
    ...
    data.forEach(function(element) {
        ...
        location.innerHTML = '<i class="fa fa-map-marker" aria-hidden="true"></i> '  + '<p class="addressInfo">' + address + '</p>';
        ...
        description.setAttribute('id', 'desc2');
